...
#define POLL_RX_TO_RESP_TX_DLY_UUS 330*5
...
static Sta_Parameter *sta_parameter_uwb;
/*! ------------------------------------------------------------------------------------------------------------------
 * @fn main()
 *
...
int rx_main(void)
{
    sta_parameter_uwb = get_static_parameter();
    ...
    while (1)
    {
        ...
        if (status_reg & SYS_STATUS_RXFCG)
        {
            ...
            if (rx_buffer[2] != sta_parameter_uwb->uwb_id)
            {
                continue;
            }
